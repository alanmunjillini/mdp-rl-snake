...
# bigfood_x=4, bigfood_y=5, bigfood_val=2
# for the command line arguments:
# --snake_head_x 5 --snake_head_y 5 --food_x 2 --food_y 2 --width 18 --height 10 --rock_x 3 --rock_y 4 --Ne 40 --C 40 --gamma 0.7 --bigfood_x 4 --bigfood_y 5 --bigfood_val 2
...
# bigfood_x=8, bigfood_y=5, bigfood_val=2
# for the command line arguments:
# --snake_head_x 5 --snake_head_y 5 --food_x 2 --food_y 2 --width 18 --height 10 --rock_x 3 --rock_y 4 --Ne 20 --C 60 --gamma 0.5 --bigfood_x 8 --bigfood_y 5 --bigfood_val 2
...
# bigfood_x=4, bigfood_y=5, bigfood_val=2
# for the command line arguments:
# --snake_head_x 3 --snake_head_y 4 --food_x 2 --food_y 2 --width 10 --height 18 --rock_x 5 --rock_y 5 --Ne 30 --C 30 --gamma 0.6 --bigfood_x 4 --bigfood_y 5 --bigfood_val 2
